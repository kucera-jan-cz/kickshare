...
public class KickstarterEndpoint {
    ...
    public void verifyBacker(@RequestParam String email, @RequestParam String password, @AuthenticationPrincipal BackerDetails user) throws IOException, AuthenticationException {
