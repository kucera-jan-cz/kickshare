...
INSERT INTO "group" (id, leader_id, name, project_id, lat, lon, location) VALUES (1, 1, 'Quodd Heroes CZ', 439380282, 49.1951, 16.6068, point(49.1951, 16.6068));
INSERT INTO user_2_group (group_id, user_id) VALUES (1, 1);
INSERT INTO user_2_group (group_id, user_id) VALUES (1, 2);

INSERT INTO "group" (id, leader_id, name, project_id, lat, lon, location) VALUES (2, 1, 'The Edge CZ', 1893061183, 49.1951, 16.6068, point(49.1951, 16.6068));
INSERT INTO user_2_group (group_id, user_id) VALUES (2, 1);
INSERT INTO user_2_group (group_id, user_id) VALUES (2, 3);

INSERT INTO "group" (id, leader_id, name, project_id, lat, lon, location) VALUES (3, 1, 'Rise of Moloch CZ Brno', 217227567, 49.1951, 16.6068, point(49.1951, 16.6068));
INSERT INTO user_2_group (group_id, user_id) VALUES (3, 1);

INSERT INTO "group" (id, leader_id, name, project_id, lat, lon, location) VALUES (4, 1, 'Rise of Moloch US Gotham', 217227567, 49.1951, 16.6068, point(49.1951, 16.6068));
