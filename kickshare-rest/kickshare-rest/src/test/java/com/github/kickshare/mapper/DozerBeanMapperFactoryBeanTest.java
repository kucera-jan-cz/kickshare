...
public class DozerBeanMapperFactoryBeanTest {
    ...
    public void domain2DB() throws Exception {
        ...
        com.github.kickshare.db.jooq.tables.pojos.Project expected
                = new com.github.kickshare.db.jooq.tables.pojos.Project(1L, "Quodd Heroes", "DESC", "URL", new Date(NOW.toEpochMilli()));
    ...
    public void db2Domain() throws Exception {
        Mapper dozer = new DozerBeanMapper(Arrays.asList("dozer/db-2-domain-mappings.xml"));
        Project domain = dozer.map(new com.github.kickshare.db.jooq.tables.pojos.Project(1L, "Quodd Heroes", "DESC", "URL", new Date(NOW.toEpochMilli())), Project.class);
