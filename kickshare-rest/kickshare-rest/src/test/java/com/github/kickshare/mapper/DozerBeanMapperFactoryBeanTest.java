...
public class DozerBeanMapperFactoryBeanTest {
    ...
    private static final Class<com.github.kickshare.db.jooq.tables.pojos.ProjectDB> DB_TYPE = com.github.kickshare.db.jooq.tables.pojos.ProjectDB.class;
    ...
    public void domain2DB() throws Exception {
        ...
        com.github.kickshare.db.jooq.tables.pojos.ProjectDB expected
                = new com.github.kickshare.db.jooq.tables.pojos.ProjectDB(1L, "Quodd Heroes", "DESC", "URL", new Date(NOW.toEpochMilli()));
    ...
    public void db2Domain() throws Exception {
        Mapper dozer = new DozerBeanMapper(Arrays.asList("dozer/db-2-domain-mappings.xml"));
        Project domain = dozer.map(new com.github.kickshare.db.jooq.tables.pojos.ProjectDB(1L, "Quodd Heroes", "DESC", "URL", new Date(NOW.toEpochMilli())), Project.class);
